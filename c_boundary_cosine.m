...
Vname.temp        = 'temp';
Vname.salt        = 'salt';
%%%%%%%%%%%%%%%%%%%%%%%%%add by zsm for cosine
  % 'alkalinity','TIC','oxygen','DDCA','CSDC','CLDC',
  % 'SDOC','SDON','LDOC','LDON',...
  %   'DDSi','DD_C','DD_N','BAC_','Z2_C',
  % 'Z2_N','Z1_C','Z1_N','S3CH','S3_C','S3_N',...
  %   'S2CH','S2_C','S2_N','S1CH','S1_C',
  % 'S1_N','PO4','SiOH4','NH4','NO3' 
Vname.alkalinity        = 'alkalinity';
Vname.TIC        = 'TIC';
Vname.oxygen        = 'oxygen';
Vname.DDCA        = 'DDCA';
Vname.CSDC        = 'CSDC';
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.alkalinity,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['alkalinity, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.TIC,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['TIC, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.oxygen,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['oxygen, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.DDCA,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['DDCA, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.CSDC,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['CSDC, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.CLDC,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['CLDC, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.SDOC,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['SDOC, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.SDON,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['SDON, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.LDOC,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['LDOC, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.LDON,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['LDON, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.DDSi,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['DDSi, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.DD_C,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['DD_C, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.DD_N,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['DD_N, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.BAC_,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['BAC_, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.Z2_C,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['Z2_C, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.Z2_N,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['Z2_N, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.Z1_C,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['Z1_C, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.Z1_N,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['Z1_N, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S3CH,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S3CH, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S3_C,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S3_C, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S3_N,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S3_N, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S2CH,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S2CH, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S2_C,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S2_C, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S2_N,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S2_N, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S1CH,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S1CH, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S1_C,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S1_C, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.S1_N,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['S1_N, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.PO4,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['PO4, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.SiOH4,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['SiOH4, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.NH4,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['NH4, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
...
for ib=1:4
  if (S.boundary(ib))
    Var.name            = strcat([Vname.NO3,'_',char(Bname(ib))]);
    Var.type            = vartype;
    Var.dimid           = [did.time did.Nr did.br(ib)];
    Var.long_name       = strcat(['NO3, ',char(Blong(ib))]);
    Var.time            = Vname.time;
    Var.coordinates     = strcat([char(BcoorXr(ib)),' ',                ...
                                  char(BcoorYr(ib)),' ',                ...
                                  Vname.s_rho,' ',Vname.time]); 
